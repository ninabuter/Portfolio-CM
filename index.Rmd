...
oldvsnew <-
  DangerouslyInLove %>%
  mutate(genre = "DangerouslyInLove") %>%
...
* I don't see other 'remarkable' things in duration and volume. 
...
* I know this graph is a bit intense to take in, and I initially wanted to take out two albums because it's so crowded, but I'm curious about the situation at y = **c02**. You can see **major differences** in this coefficient between the four albums.  
